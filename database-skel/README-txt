...
on neubot.org website in sqlite3 format.

To understand what the results in the database represent you need to read
at least the whole ``technical questions'' section of Neubot FAQs::

    http://www.neubot.org/faq#technical-questions

You should also review the history of the files that implements the
transmission tests:
...
privacy_can_share
    ...
    The name `privacy_can_share` is deprecated and will be replaced by
